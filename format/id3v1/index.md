...
- **文字列**:
  エンコードは指定されません。
  ヌル文字または指定の長さで終わる文字列です。
  文字列が短い場合は残りをヌル文字などで埋めます。
- **数字**:
  `"0123456789"` に含まれる文字です。
- **数値**:
  符号なし整数です。
...
音楽のタイトルです。
文字列が長い場合は残りを enhanced title に保存します。

## artist

音楽のアーティスト名です。
文字列が長い場合は残りを enhanced artist に保存します。

## album

音楽のアルバム名です。
文字列が長い場合は残りを enhanced album に保存します。
